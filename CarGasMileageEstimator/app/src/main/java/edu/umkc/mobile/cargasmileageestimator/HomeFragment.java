...
public class HomeFragment extends android.support.v4.app.Fragment {
    ...
    String GET_CAR_API_URL = "http://10.205.0.55:8080/api/getAllCarDetails/";
...
// representation of a date with the defined format.
        ...
        new HttpGetCarDetailsAsyncTask().execute(GET_CAR_API_URL);
        ...
        protected void onPostExecute(String result) {
            try {
                if(result!=null && !"".equalsIgnoreCase(result)){
                    ...
                    double adjustedRange = 0;
                    adjustedRange = Double.parseDouble(mileageText.getText().toString()) * Double.parseDouble(gasText.getText().toString());
                    String range = Double.toString((double)Math.round(adjustedRange*100.0)/100.0)+" miles";
